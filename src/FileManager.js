...
//제이슨 파일 가져오기
const getJsonFromFile = (directory,fileName) =>{
...
const localUpdate = (directory,fileName,localDataList,webDataList) => {
...
module.exports = {
    ...
    updateJson : function(directory,fileName,localDataList,webDataList){
       localUpdate(directory,fileName,localDataList,webDataList);
    }
